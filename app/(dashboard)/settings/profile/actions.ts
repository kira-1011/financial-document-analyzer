...
export async function changePasswordAction(
    ...
    try {
        ...
        return {
            message: error instanceof APIError ? error.message : "Failed to change password. Check your current password.",
        };
    }
}
...
export async function deleteAccountAction(
    ...
    try {
        ...
        return {
            message: error instanceof APIError ? error.message : "Failed to delete account. Check your password.",
        };
    }
