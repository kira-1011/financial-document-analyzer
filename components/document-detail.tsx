                    ...
                    <div>
                        <div className="flex items-center gap-3">
                            ...
                            <Badge variant={getStatusBadgeVariant(document.status)} className="gap-1">
                                ...
                                {DOCUMENT_STATUS_LABELS[document.status as keyof typeof DOCUMENT_STATUS_LABELS] || document.status}
                            </Badge>
                        </div>
                        <div className="flex items-center gap-4 mt-1 text-sm text-muted-foreground">
                            ...
                            <span>Uploaded {formatDistanceToNow(new Date(document.createdAt), { addSuffix: true })}</span>
                        ...
                        <div>
                            ...
                            <dd className="text-sm mt-1">
                                {document.processedAt
                                    ? format(new Date(document.processedAt), "PPp")
                                    : "-"}
                            </dd>
                        </div>
                    </dl>
