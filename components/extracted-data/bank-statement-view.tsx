        ...
        <div className="space-y-6">
            ...
            <div className="grid gap-4 md:grid-cols-2 lg:grid-cols-4">
                ...
                <Card>
                    ...
                    <CardContent>
                        <div className="text-lg font-bold">
                            {formatDate(data.statement_period.start_date)}
                        </div>
                        <p className="text-xs text-muted-foreground">
                ...
                <Card>
                    ...
                    <CardContent>
                        ...
                        <p className="text-xs text-muted-foreground">
                            {netChange >= 0 ? "+" : ""}{netChangePercent}% from opening
                        </p>
                    </CardContent>
                </Card>
            </div>
            ...
            <Card>
                <CardHeader>
                    ...
                    <CardDescription>
                        {data.transactions.length} transaction{data.transactions.length !== 1 ? "s" : ""} in this period
                    </CardDescription>
                </CardHeader>
                <CardContent>
                                        ...
                                        <TableRow key={index}>
                                            ...
                                            <TableCell>
                                                <Badge
                                                    ...
                                                    className={tx.type === "credit" ? "bg-green-100 text-green-800 dark:bg-green-900 dark:text-green-100" : "bg-red-100 text-red-800 dark:bg-red-900 dark:text-red-100"}
                                                >
                                                    {tx.type}
                                                </Badge>
                                            </TableCell>
